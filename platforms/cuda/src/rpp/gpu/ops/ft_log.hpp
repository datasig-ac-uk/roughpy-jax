#ifndef PLATFORMS_CUDA_SRC_RPP_GPU_OPS_FT_LOG_HPP
#define PLATFORMS_CUDA_SRC_RPP_GPU_OPS_FT_LOG_HPP
...
class FTLog<gpu::strategies::BlockStrategy<Scalar_, Accum_, BlockSize, Architecture>, Basis>
...
#endif //PLATFORMS_CUDA_SRC_RPP_GPU_OPS_FT_LOG_HPP
